...
const mapStateToProps = (state) => ({
  ...
  fetch_item_modal_emotion: state.fetchPersonal.fetch_item_modal_emotion,
  fetch_item_modal_comment: state.fetchPersonal.fetch_item_modal_comment,
  show_list_comment: state.fetchPersonal.show_list_comment,
});
